...
fn test_3_top() {
    assert_eq!(
        SolutionTop::length_of_longest_substring("abcabcbb".to_string()),
        3
    );
    assert_eq!(
        SolutionTop::length_of_longest_substring("bbbbb".to_string()),
        1
    );
    assert_eq!(
        SolutionTop::length_of_longest_substring("pwwkew".to_string()),
        3
    );
    assert_eq!(SolutionTop::length_of_longest_substring("dvdf".to_string()), 3);
}
